...
public class PatientService {
	...
	public PatientResponseDTO createPatient(PatientRequestDTO patientRequestDTO) {
		if(patientRepository.existsByEmail(patientRequestDTO.getEmail())) {
			throw new EmailAlreadyExistException("Email already used by another patient :"+patientRequestDTO.getEmail());
		} else {
...
//				.orElseThrow(()->new PatientNotFoundException("Patient Not Found With Record "+id));
//		
//		if(patientRepository.existsByEmail(patientRequestDTO.getEmail())) {
//			throw new EmailAlreadyExistException("Email already used by another patient :"+patientRequestDTO.getEmail());
//		}
